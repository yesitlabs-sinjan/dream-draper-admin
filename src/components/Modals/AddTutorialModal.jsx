...
//                                 className={`upload-content-input ${formik.touched.type && formik.errors.type ? 'is-invalid' : ''}`}
//                                 name="type"
...
//                                 </div>
//                                 <div className="upload-text-another">
//                                     <button type="button" className="image-size">{(uploadedFile.size / (1024 * 1024)).toFixed(2)} MB</button>
//                                     <img src="./images/blue-cross.svg" className="blue-cross" onClick={handleRemoveFile} style={{ cursor: 'pointer' }} />
//                                 </div>
//                             </div>
//                         )}
...
//                             <button type="button" className="uploadCancel" data-bs-dismiss="modal" onClick={closeModal}>Cancel</button>
//                             <button type="submit" className="uploadSubmit"  data-bs-dismiss="modal">{isEdit ? 'Update Tutorial' : 'Add Tutorial'}</button>
//                         </div>
